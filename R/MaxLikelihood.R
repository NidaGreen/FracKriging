...
#'
#' @return   NULL
#' @value Returns the estimate of the Hurst parameter (a real in [0,1))
#'  of the fractional Brownian vector fields and and a graph indicating the minimized maximum likelihood function with the Hurst parameter.
#' @examples
